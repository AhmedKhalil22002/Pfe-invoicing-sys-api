...
import { ResponseArticlePurchaseQuotationEntryDto } from 'src/modules/purchase-quotation/dtos/article-purchase-quotation-entry.response.dto';
...
import { ResponsePurchaseQuotationMetaDataDto } from './purchase-quotation-meta-data.response.dto';
...
import { ResponsePurchaseQuotationUploadDto } from './purchase-quotation-upload.response.dto';

export class ResponsePurchaseQuotationDto {
  ...
  @ApiProperty({ type: () => ResponseArticlePurchaseQuotationEntryDto, isArray: true })
  articlePurchaseQuotationEntries?: ResponseArticlePurchaseQuotationEntryDto[];

  @ApiProperty({ type: () => ResponsePurchaseQuotationMetaDataDto })
  purchaseQuotationMetaData?: ResponsePurchaseQuotationMetaDataDto;

  @ApiProperty({ required: false })
  uploads?: ResponsePurchaseQuotationUploadDto[];
